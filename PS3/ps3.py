...
class RectangularRoom(object):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        if pos in self.tiles and self.tiles[pos] > 0:
    ...
    def is_position_in_room(self, pos):
        ...
        """
        o=(math.floor(pos.get_x()),math.floor(pos.get_y()))
        return o in self.tiles
    ...
    def is_position_valid(self, pos):
        ...
        """
        # do not change -- implement in subclasses
        pos=Position(math.floor(pos.get_x()),math.floor(pos.get_y()))
...
class EmptyRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        """
        w=self.width*random.random()
        h=self.height*random.random()
...
class FurnishedRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        while 1:
            w=self.width*random.random()
            h=self.height*random.random()
            tile=(math.floor(w),math.floor(h))
...
##       of a 20x20 room?
    #the standard robot takes less steps than faulty
## 2) How does the performance of the two robot types compare when two of each
##       robot cleans 80% of rooms with dimensions 
##       10x30, 20x15, 25x12, and 50x6?
#    they are different till aspect ratio 2 then becomes linear
##
##
#
